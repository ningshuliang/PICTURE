...
if __name__ == '__main__':
    ...
    test_path1 = '/data1/shuliang/CVPR_Code_Release/Sample_data/Img_Clear'
    test_path2 = '/data1/shuliang/CVPR_Code_Release/Sample_data/Img_Wo_Cloth'
    # for test_path3  it can be change to the parsing path generated by stage 1
    test_path3 = '/data1/shuliang/CVPR_Code_Release/Sample_data/Parsing_generate_by_stage1'
    test_path4 = '/data1/shuliang/CVPR_Code_Release/Sample_data/Cloth_White_Background'
    test_path5 = '/data1/shuliang/CVPR_Code_Release/Sample_data/Parsing_Clear'
    ...
    model.load_state_dict(torch.load('/data1/shuliang/CVPR_Code_Release/pretrain_models/Stage2/model_210000.pth'))
    ...
    mlp_layer0.load_state_dict(torch.load('/data1/shuliang/CVPR_Code_Release/pretrain_models/Stage2/mlp_layer0_210000.pth'))
        ...
        for batch_id,batch in enumerate(test_dataloader):
            ...
            with torch.no_grad():
                ...
                for id_sample, x_sample in enumerate(x_samples_ddim):
                    ...
                    cv2.imwrite(os.path.join('/data1/shuliang/CVPR_Code_Release/Sample_data/Final_results', file_name), img[:,:,::-1])
